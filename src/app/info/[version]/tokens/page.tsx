...
const Tokens = () => {
  return (
    <div>
      <p className=" font-semibold text-2xl text-white">Your Watchlist</p>
      <div className=" bg-[#1A1D20]  text-[#f2f2f2] py-5 text-sm font-medium px-4 rounded-3xl mt-5">
        Saved tokens will appear here
      </div>
      <div className=" bg-[#1A1D20]  text-white py-2  font-medium px-4 rounded-3xl mt-5">
        <p className=" text-sm mb-4 font-normal">Top Movers</p>
        <div className=" border w-fit mt5  rounded-2xl gap-3 border-white/20 px-4 py-2 flex items-center justify-between">
